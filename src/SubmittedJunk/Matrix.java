...
public class Matrix
{
    ...
    /*
     * Creates a SubmittedJunk.Matrix object given a 2D integer array
     */
     ...
     * <p>
     * If we have a SubmittedJunk.Matrix with elements :
     * 1 2 3
     * 4 5 6
     * 7 8 9
     * <p>
    ...
    public Matrix additiveInverse()
    {
        ...
        for (int i = 0; i < cols; i++)
        {
            ...
            {
                inverse.setElement(i, j, -1 * matrix[i][j]);
            }
        }
        return inverse;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 2; i++) {
            System.out.println("SubmittedJunk.Matrix No. " + (i + 1));
            ...
            System.out.println("SubmittedJunk.Matrix " + (i + 1) + ":");
